...
/**
 * Util Class to abstract IAM Roles Complexity
 * Completely ECS Focused, allows to not duplicate code
 * Creates Roles and corresponding policies.
 */
export class IamRoleResource extends Resource implements IPrincipal {
